...
<Ingress size='xs'>Søkeendepunktet lar deg søke på data.norge.no med Elastic search. 
Tenesten som er ansvarleg for å handtere søk er [fdk-search-service(Github)](https://github.com/Informasjonsforvaltning/fdk-search-service).</Ingress>
