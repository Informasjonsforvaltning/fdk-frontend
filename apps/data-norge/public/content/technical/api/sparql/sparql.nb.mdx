...
<Ingress>
  SPARQL-endepunktet er det kraftigste søkeverktøyet på Data.norge.no og gir deg mulighet til å søke på alle egenskaper
  som finnes i katalogene, så lenge du behersker syntaksen. Tjenesten som er ansvarlig for å håndtere SPARQL er
