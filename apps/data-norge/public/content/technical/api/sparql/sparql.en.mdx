...
<Ingress>
    ...
    that exists in the catalogs, as long as you master the syntax. The service that is responsible for handling SPARQL
    is [fdk-sparql-service(Github)](https://github.com/Informasjonsforvaltning/fdk-sparql-service).
</Ingress>
...
```bash
curl "https://sparql.demo.fellesdatakatalog.digdir.no?query=\
PREFIX%20dcat%3A%20%3Chttp%3A%2F%2Fwww.w3.org%2Fns%2Fdcat%23%3E%0A\
SELECT%20*%0AWHERE%20%7B%0A%20%20%3Fdataset%20a%20dcat%3ADataset%20.%0A%7D%0A\
LIMIT%2010"
```
