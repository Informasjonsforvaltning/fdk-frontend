...
<Ingress>
    The AI search uses metadata from Data.norge.no and helps you find datasets using artificial intelligence. The service that is responsible for handling AI searches is [fdk-llm-search-service(Github)](https://github.com/Informasjonsforvaltning/fdk-llm-search-service).
</Ingress>
