...
description: Denne sida skal hjelpe deg med korleis du kan registrere innhald i katalogane på vegner av verksemda di.
---

# Kom i gang med registrering

Denne sida skal hjelpe deg med korleis du kan registrere innhald i katalogane på vegner av verksemda di.
...
Du finn meir informasjon om tilgangane og om korleis fullmakter blir tildelte på [Altinn si skjemaoversikt for tenesta Data.norge.no](https://info.altinn.no/skjemaoversikt/digitaliseringsdirektoratet/Data.norge.no).
...
Dersom det er første gong verksemda di tek i bruk FDK, må nokon i verksemda som har verksemdsadministratortilgang til registreringsløysinga til FDK akseptere [bruksvilkår](/docs/sharing-data/terms-of-use) på vegner av verksemda. Dersom dei ikkje blir aksepterte, vil det ikkje bli oppretta katalogar for verksemda di.
