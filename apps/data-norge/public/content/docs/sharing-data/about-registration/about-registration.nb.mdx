---
title: Kom i gang med registrering
description: Denne siden skal bistå deg med hvordan du kan registrere innhold i katalogene på vegne av din virksomhet.
---

# Kom i gang med registrering

Denne siden skal bistå deg med hvordan du kan registrere innhold i katalogene på vegne av din virksomhet.
...
Du finner mer informasjon om tilgangene og om hvordan fullmakter tildeles på [Altinns skjemaoversikt for tjenesten Data.norge.no](https://info.altinn.no/skjemaoversikt/digitaliseringsdirektoratet/Data.norge.no).
...
Hvis det er første gang din virksomhet tar i bruk FDK må noen i virksomheten som har virksomhetsadministratortilgang til registreringsløsningen til FDK akseptere [bruksvilkår](/docs/sharing-data/terms-of-use) på vegne av virksomheten. Hvis de ikke aksepteres, vil det ikke opprettes kataloger for din virksomhet.
