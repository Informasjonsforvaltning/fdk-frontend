...
<Alert size='small'>
    Gå til [veiledning for hvordan lage beskrivelser
    selv](/docs/sharing-data/publishing-data-descriptions/1-creating-descriptions-self) om du vil lage og forvalte
    beskrivelsene selv.
</Alert>
