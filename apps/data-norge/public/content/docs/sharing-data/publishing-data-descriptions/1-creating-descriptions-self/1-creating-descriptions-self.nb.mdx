...
<Ingress>
  ...
  neste steg må du [sette opp høsting](/docs/sharing-data/publishing-data-descriptions/3-publishing-descriptions) i
...
<Alert>
  Se [Flere relevante ressurser](/docs/resources) for mer informasjon om de ulike spesifikasjonene Data.norge.no baserer
  seg på.
</Alert>
