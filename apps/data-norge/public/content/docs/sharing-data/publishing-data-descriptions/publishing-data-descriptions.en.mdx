...
<Alert data-size='sm'>Go to [How to get access to Data.norge.no's solutions](/docs/sharing-data/login-and-access).</Alert>
...
<Alert data-size='sm'>
    Further into the guide you will get info on [How to register a harvesting
    endpoint](/docs/sharing-data/publishing-data-descriptions/3-publishing-descriptions).
</Alert>
