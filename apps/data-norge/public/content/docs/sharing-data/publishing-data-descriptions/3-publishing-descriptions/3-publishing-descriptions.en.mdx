...
If you wish to manually trigger harvesting of your descriptions, you can read about [how to trigger harvesting](/docs/sharing-data/publishing-data-descriptions/4-triggering-harvest) or go directly to the [administration interface for harvesting](https://admin.fellesdatakatalog.digdir.no/data-sources).
...
- The data returned must be in one of the [formats supported by Data.norge.no](/docs/sharing-data/publishing-data-descriptions/1-creating-descriptions-self).
- The data must be described according to the relevant specification. Read more about [how to create descriptions](/docs/sharing-data/publishing-data-descriptions/1-creating-descriptions-self).
- You must have the necessary permissions to use the solution. Read more about [how to get access](/docs/sharing-data/login-and-access).
