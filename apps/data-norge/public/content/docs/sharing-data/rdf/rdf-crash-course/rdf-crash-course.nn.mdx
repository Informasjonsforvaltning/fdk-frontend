...
Om du ikkje allereie har lese den, ta gjerne ein titt på artikkelen om [kvifor Data.norge.no brukar RDF](/docs/sharing-data/rdf), der får du ein overordna forklaring på kva RDF er.
...
![Ein RDF-graf, som viser nokre utsegner om Leonardo da Vinci](/images/content/da_vinci_graph_ex_5095760b07.png)
...
Ein URI, eller _Unique Resource Identifier_, er ein global og unik identifikator, og dette er grunnen til at ein brukar URI-ar for å namnsetja ressursar i RDF: då kan kven som helst, kvar som helst bruka URI-en og vita at dei snakkar om same ting.
...
<Alert>**Tips**: Du kan òg angi kva språk ein tekst er på, for eksempel slik `"tekst på bokmål"@nb`.</Alert>
...
![Graf som inneholder utsagn om Ada Lovelace](/images/content/ada_lovelace_graph_3c97a51392.png)
...
Vi brukar ressursar som allereie er definerte av andre, som RDF-navnerommet, Schema.org eller _Friend of a friend_ (FOAF).
...
Sidan vi ofte brukar predikatet `rdf:type` tilbyr Turtle forkortelsen `a`. Så dette tripplet:
