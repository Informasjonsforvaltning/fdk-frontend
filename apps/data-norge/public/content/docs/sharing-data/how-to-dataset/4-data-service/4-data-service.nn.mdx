...
<Alert data-color="warning">
  **Merk**: Datasettet _KI-prosjekter i offentlig sektor_ er ikkje tilgjengeliggjort via API, så lenkene og endepunktene
  oppgitt for API-et i dømet under er ikkje verkelege og vil ikkje fungere. Døma her er kun meint å illustrere korleis
  ein API-beskriving ser ut.
</Alert>
