...
<Alert>
    **Nyttig å vite**: Vi må lage beskrivinga i eit strukturert dataformat som data.norge.no sitt system kan forstå.
    ...
    fleire private verksemder sine datakatalogar. RDF kan skrivast på fleire ulike måtar – i døma under brukar vi
    RDF-formatet som heiter Turtle – men du vel sjølv kva for eitt du vil bruka. [Du kan lese meir om RDF
