...
<Alert>
  **Nyttig å vite**: Vi må lage beskrivelsen i et strukturert dataformat som Data.norge.no sitt system kan forstå. Dette
  formatet heter RDF (Resource Description Framework) og er i bruk også blant andre europeiske dataportaler og i flere
  private virksomheter sine datakataloger. RDF kan skrives på flere ulike måter – i eksemplene under bruker vi
...
<Alert data-color="warning">
  **Viktig**: Du bør bruke et tekstredigeringsprogram som ikke formaterer teksten. Microsoft Word egner seg dårlig, mens
  Windows Notepad, VS Code eller lignende fungerer bra.
</Alert>
...
<Alert>**Tips**: Du kan legge inn kommentarer i Turtle med tegnet `#`, da ignoreres det som kommer etter.</Alert>
