...
<Alert>
  **Note**: If your organization already has a data catalog that Data.norge.no harvests from, you do not need to
  register a separate endpoint for your dataset description. Just make sure that your dataset description is included in
  the organization's data catalog.
</Alert>
...
The next step is to register the data source in the Data.norge.no administration portal. You log in to the [administration solution for harvesting endpoints](https://admin.fellesdatakatalog.digdir.no/). See [Get started with harvesting](/docs/sharing-data/about-harvesting) for a walkthrough.

<Alert>
  **Note**: You must have the correct permissions and rights to register the data source on behalf of your organization.
  Learn more about [how to get access](/docs/sharing-data/login-and-access) to Data.norge.no's solutions.
</Alert>
...
![The Norwegian Digitalisation Agency is selected as Publisher](/images/content/publisher_436431d9fc.png)
...
![Dataset is selected under Catalog](/images/content/catalog_5b32c1d760.png)

![DCAT-AP-NO is selected for Data Source Type](/images/content/data_source_type_7945b706f1.png)

The format (in our case) is Turtle, but here you select the RDF format you provide the description in.

![Turtle is selected for Format](/images/content/format_a178ba8a09.png)
...
![Name of data source is filled out with "Data Catalog for the Norwegian Digitalisation Agency"](/images/content/name_995474230a.png)
...
![URL to the data source is filled out with the link to the file on Github](/images/content/url_20dd8399c0.png)

We have no authentication for this data source, so we leave those fields empty:
![The two fields under Authentication - HTTP Header are left empty](/images/content/authentication_c4674b80ce.png)

Then click "Save."

The data source should now appear in the list of data sources. Ours looks like this:
![The entry "Data Catalog for the Norwegian Digitalisation Agency" is displayed, with information about publisher, URI to the data source, format, and with the buttons Harvest, Harvest Status, Edit, Validate, and Delete](/images/content/data_source_entry_d25303217f.png)
...
<Alert>
  **Tip**: The description of the AI overview dataset is located here: [TODO:add-link](https://data.norge.no/datasets/)
</Alert>
