...
<Ingress>
  Alle data som din virksomhet har registrert i Behandlingsoversikt kan enkelt tas ut av løsningen og overføres til din
  virksomhet som rapporter. Rapporter kan genereres i HTML-format eller som CSV-filer (Comma-Separated-Values).
  HTML-format er tilpasset visning i nettleser og kan skrives ut eller lagres som PDF-filer. CSV-format er egnet til
  videre bruk i databaser eller i regneark.
</Ingress>
...
![Bilde som viser hvor knappen «Generer rapport» er på behandlingsoversiktsiden.](/images/content/Behandlingsoversikt_knapp_generer_rapport_5dc8ab6b63.png)

&nbsp;

Du kan da velge mellom fire rapporter; Behandlingsoversikt, Behandlingsoversikt CSV, Protokoll og Protokoll CSV:

![Bilde som viser at knappen «Generer rapport» er valgt og at under denne er det fire rapporttyper.](/images/content/Behandlingsoversikt_valg_generer_rapport_e74b90fefc.png)
...
![Bilde av et eksempel på rapport «Behandlingsoversikt» som HTML.](/images/content/Behandlingsoversikt_rapport_html_b319cdf7da.png)
...
![Bilde av et eksempel på rapport «Behandlingsoversikt» som HTML og uten innhold.](/images/content/Behandlingsoversikt_rapport_html_tema_uten_innhold_97c2aba9fe.png)
...
![Bilde som viser eksempel på rapport «Behandlingsoversikt CSV» åpnet i MS Excel.](/images/content/Behandlingsoversikt_rapport_CSV_eksempel1_127c7da850.png)
...
![Bilde som viser eksempel på rapport Behandlingsoversikt CSV» åpnet i MC Excel der det er registrert tre personer med daglig behandlingsansvar for en behandlingsaktivitet.](/images/content/Behandlingsoversikt_rapport_CSV_eksempel_Lonn_52c0a151a2.png)
...
![Bilde som viser temaene «Kontaktinformasjon» og «Personvernombud» i Behandlingsoversikt.](/images/content/Behandlingsoversikt_kontakt_og_personvern_1b17c54e27.png)
...
![Bilde av et eksempel på rapport «Protokoll» som HTML.](/images/content/Behandlingsoversikt_protokoll_html_6e789eaad5.png)
...
![Bilde som viser et eksempel på rapport «Protokoll CSV» åpnet i MS Excel.](/images/content/Behandlingsoversikt_rapport_protokoll_CSV_eksempel_eba15ff1ec.png)
