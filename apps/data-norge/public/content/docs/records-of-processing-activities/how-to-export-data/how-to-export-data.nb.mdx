...
<Ingress>
    Alle data som din virksomhet har registrert i Behandlingsoversikt kan enkelt tas ut av løsningen og overføres til
    din virksomhet som rapporter. Rapporter kan genereres i HTML-format eller som CSV-filer (Comma-Separated-Values).
