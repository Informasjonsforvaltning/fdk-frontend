...
<Ingress>
  Alle data som din verksemd har registrert i Behandlingsoversikt kan enkelt hentast ut av løysinga og overførast til
  din verksemd som rapportar. Rapportar kan genererast i HTML-format eller som CSV-filer (Comma-Separated-Values).
  HTML-formatet er tilpassa vising i nettlesar og kan skrivast ut eller lagrast som PDF-filer. CSV-formatet er eigna for
  vidare bruk i databasar eller i rekneark.
</Ingress>
...
![Bilete som viser kor knappen «Generer rapport» er på behandlingsoversikt-sida.](/images/content/Behandlingsoversikt_knapp_generer_rapport_5dc8ab6b63.png)

&nbsp;

Du kan då velje mellom fire rapportar; Behandlingsoversikt, Behandlingsoversikt CSV, Protokoll og Protokoll CSV:

![Bilete som viser at knappen «Generer rapport» er valt, og at det er fire rapporttypar under denne.](/images/content/Behandlingsoversikt_valg_generer_rapport_e74b90fefc.png)
...
![Bilete av eit eksempel på rapport «Behandlingsoversikt» som HTML.](/images/content/Behandlingsoversikt_rapport_html_b319cdf7da.png)
...
![Bilete av eit eksempel på rapport «Behandlingsoversikt» som HTML og utan innhald.](/images/content/Behandlingsoversikt_rapport_html_tema_uten_innhold_97c2aba9fe.png)
...
![Bilete som viser eksempel på rapport «Behandlingsoversikt CSV» opna i MS Excel.](/images/content/Behandlingsoversikt_rapport_CSV_eksempel1_127c7da850.png)
...
![Bilete som viser eksempel på rapport «Behandlingsoversikt CSV» opna i MS Excel der det er registrert tre personar med dagleg behandlingsansvar for ein behandlingsaktivitet](/images/content/Behandlingsoversikt_rapport_CSV_eksempel_Lonn_52c0a151a2.png)
...
![Bilete som viser temaene «Kontaktinformasjon» og «Personvernombod» i Behandlingsoversikt.](/images/content/Behandlingsoversikt_kontakt_og_personvern_1b17c54e27.png)
...
![Bilete av eit eksempel på rapport «Protokoll» som HTML.](/images/content/Behandlingsoversikt_protokoll_html_6e789eaad5.png)
...
![Bilete som viser eit eksempel på rapport «Protokoll CSV» opna i MS Excel.](/images/content/Behandlingsoversikt_rapport_protokoll_CSV_eksempel_eba15ff1ec.png)
