...
Data.norge.no offers several ways to search for data: Standard text search with filtering, artificial intelligence search, SPARQL queries, and resource service.
...
[Read more about resource service](/docs/finding-data/resource-service)
