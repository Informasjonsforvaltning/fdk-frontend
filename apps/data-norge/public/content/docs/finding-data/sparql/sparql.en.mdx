...
- [SPARQL Sandbox](https://data.norge.no/nb/sparql) - Interactive environment for testing SPARQL queries
- **SPARQL backend service**: `https://sparql.fellesdatakatalog.digdir.no` - Production SPARQL endpoint
