...
Du kan teste og utføre SPARQL-spørringer i vår interaktive SPARQL-sandkasse. Sandkassen gir deg eit brukarvensleg grensesnitt for å utforske norske offentlege data og finjustere dine spørringer.

- [SPARQL-sandkasse](https://data.norge.no/nb/sparql) - Interaktivt miljø for å teste SPARQL-spørringer
- **SPARQL backend service**: `https://sparql.fellesdatakatalog.digdir.no` - Produksjons-SPARQL-endepunkt
