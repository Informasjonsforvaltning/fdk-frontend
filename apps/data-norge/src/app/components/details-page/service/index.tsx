    ...
    service.hasInput?.map((evidence) => {
      ...
      if (evidence.language?.length || showEmptyRows) {
        contents.push({
          ...
          value: evidence.language?.map((language: any) => printLocaleValue(locale, language.prefLabel)).join(", "),
        });
      }
                  ...
                  <Fragment key={item.id}>
                    <dt>
                      <Link href={`/${locale}/services/${item.id}/${getSlug(item, locale)}`}>
                        {printLocaleValue(locale, item.title) || dictionaries.detailsPage.header.namelessService}
                      </Link>
                    </dt>
                  ...
                  service.contactPoint.map((contactPoint, index) => (
                    ...
                    >
                      {!contactPoint.contactType && !showEmptyRows ? null : (
                        <>
                          <dt>{dictionaries.detailsPage.details.contactPoint.formattedName}:</dt>
                          <dd>
            ...
            <Dlist className={styles.dlist}>
              ...
              <dd>
                {publisherId ? (
                  ...
                  publisherLabel || <PlaceholderText>{dictionaries.detailsPage.details.noData}</PlaceholderText>
                )}
              </dd>
                        ...
                        renderItem={(spatial) =>
                          spatial.uri ? (
                            <ExternalLink
                              ...
                              gateway
                            >
                              {spatial.prefLabel ? printLocaleValue(locale, spatial?.prefLabel) : spatial.uri}
                            </ExternalLink>
                          ) : (
