...
-   [How to create descriptions](/docs/tutorials/publishing-data-descriptions/1-creating-descriptions-self)
    [The next step](/docs/tutorials/publishing-data-descriptions/1-creating-descriptions-self) in the guide shows you have to create the descriptions.

<Alert size='sm'>
    Further into the guide you will get info on [How to register a harvesting
    endpoint](/docs/tutorials/publishing-data-descriptions/3-publishing-descriptions)
</Alert>
...
-   [How to create descriptions with the registration solution](/docs/tutorials/publishing-data-descriptions/2-creating-descriptions-registration)
