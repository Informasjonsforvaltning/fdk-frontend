...
- Standard for beskrivelse av datasett, datatjenester og datakataloger ([DCAT-AP-NO](https://data.norge.no/specification/dcat-ap-no))
- Forvaltningsstandard for begrepsbeskrivelser ([SKOS-AP-NO-Begrep](https://data.norge.no/specification/skos-ap-no-begrep))
- Spesifikasjon for beskrivelse av informasjonsmodeller ([ModellDCAT-AP-NO](https://data.norge.no/specification/modelldcat-ap-no))
