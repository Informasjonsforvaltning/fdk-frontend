...
<Alert
    size="sm"
>
    Gå til [Hvordan få tilgang til data.norge.no sine løsninger](/docs/login-and-access).
</Alert>
...
<Alert
    size="sm"
>
    Lenger frem i veiledningen får du informasjon om [Hvordan registrere endepunkt for høsting](/docs/sharing-data/publishing-data-descriptions/3-publishing-descriptions)
</Alert>
