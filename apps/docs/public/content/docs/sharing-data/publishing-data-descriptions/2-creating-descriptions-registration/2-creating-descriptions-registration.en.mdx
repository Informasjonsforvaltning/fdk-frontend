...
The registration solution on Data.norge.no generates RDF graphs/descriptions according to the specification, but the solution does not support all the fields in the specifications. If there are fields you need to use that are not supported, you may want to manage the description yourself and [set up harvesting](/docs/tutorials/publishing-data-descriptions/3-publishing-descriptions) to Data.norge.no.

<Alert
    size="small"
>
Go to [the guide on how to create descriptions yourself](/docs/tutorials/publishing-data-descriptions/1-creating-descriptions-self) if you want to create and administer the description yourself.
</Alert>
