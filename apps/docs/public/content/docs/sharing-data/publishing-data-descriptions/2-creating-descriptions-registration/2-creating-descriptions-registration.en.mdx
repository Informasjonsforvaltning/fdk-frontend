...
More informastion about [access and how to login](/docs/login-and-access)
...
<Alert
    size="small"
>
Go to [the guide on how to create descriptions yourself](/docs/sharing-data/publishing-data-descriptions/1-creating-descriptions-self) if you want to create and administer the description yourself.
</Alert>
