...
Registreringsløsningen på Data.norge.no genererer RDF-grafer/beskrivelser i henhold til spesifikasjonen, men løsningen støtter ikke alle feltene som fins i spesifikasjonene. Er det noen felter du trenger å bruke som ikke er støttet kan du vurdere å forvalte beskrivelsen selv og [sette opp høsting](/docs/sharing-data/publishing-data-descriptions/3-publishing-descriptions) til Data.norge.no.

<Alert
    size="small"
>
Gå til [veiledning for hvordan lage beskrivelser selv](/docs/sharing-data/publishing-data-descriptions/1-creating-descriptions-self) om du vil lage og forvalte beskrivelsene selv.
</Alert>
