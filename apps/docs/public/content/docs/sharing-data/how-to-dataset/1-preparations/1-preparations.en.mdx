...
<Alert size='sm'>
    Tip: Questions regarding whether the dataset should be open or closed and which licenses should be used are often something legal experts must decide. While these clarifications are being made, you can still publish all other information.
