...
<Alert size='sm'>
    **Tips**: Vi har ei eiga side som går i detalj om [korleis bruke
    kodar](/docs/sharing-data/how-to-dataset/7-extras-code-lists) for å merke datasett tematisk, angi dekningsområde,
    lisenser mm. Ta gjerne ein kikk der om du lurar på noko.
</Alert>
