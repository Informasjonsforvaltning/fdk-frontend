...
<Alert size='sm'>
    **Tips**: Vi har en egen side som går i detalj om [hvordan bruke
    koder](/docs/sharing-data/how-to-dataset/7-extras-code-lists) for å merke datasett tematisk, angi dekningsområde,
    lisens mm. Ta gjerne en kikk der om du lurer på noe.
</Alert>
