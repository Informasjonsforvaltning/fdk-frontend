...
<Alert
    size='sm'
>
    **Merk**: Du må ha de riktige tilgangene og rettighetene for å kunne registrere datakilde på vegne av virksomheten. Les mer om [hvordan få tilgang](/docs/login-and-access) til data.norge.no sine løsninger.
</Alert>
