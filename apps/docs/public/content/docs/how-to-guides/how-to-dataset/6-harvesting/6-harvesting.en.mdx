...
<Alert
    size='sm'
>
    **Note**: You must have the correct permissions and rights to register the data source on behalf of your organization. Learn more about [how to get access](/docs/login-and-access) to data.norge.no's solutions.
</Alert>
