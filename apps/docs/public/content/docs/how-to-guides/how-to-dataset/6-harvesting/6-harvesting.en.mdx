...
<Alert size='sm'>
    **Note**: You must have the correct permissions and rights to register the data source on behalf of your
    organization. Learn more about how to get access on the [Collaboration
    Portal](https://samarbeid.digdir.no/felles-datakatalog/ta-i-bruk-felles-datakatalog/1619).
</Alert>
