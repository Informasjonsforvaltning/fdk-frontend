...
<Alert
    size='sm'
>
    **Note**: If your organization already has a data catalog that data.norge.no harvests from, you do not need to register a separate endpoint for your dataset description. Just make sure that your dataset description is included in the organization's data catalog.
</Alert>
...
<Alert
    size='sm'
>
    **Note**: You must have the correct permissions and rights to register the data source on behalf of your organization. Learn more about how to get access on the [Collaboration Portal](https://samarbeid.digdir.no/felles-datakatalog/ta-i-bruk-felles-datakatalog/1619).
</Alert>
...
<Alert
    size='sm'
>
    **Note**: If you do not see your organization here, check that you have the correct permissions and rights on behalf of your organization.
</Alert>
...
<Alert
    size='sm'
>
    **Note**: You can validate the description by clicking "Validate." You will be taken to data.norge.no's [validation tool](https://data.norge.no/validator) for descriptions.
</Alert>
