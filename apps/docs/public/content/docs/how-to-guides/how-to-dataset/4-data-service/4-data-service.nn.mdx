...
<Alert
    ...
    size='sm'
>
    **Merk**: Datasettet _KI-prosjekter i offentlig sektor_ er ikkje tilgjengeliggjort via API, så lenkene og endepunktene oppgitt for API-et i dømet under er ikkje verkelege og vil ikkje fungere.
    Døma her er kun meint å illustrere korleis ein API-beskriving ser ut.
</Alert>
...
For å seie at datatjenesten tilbyr dataen for datasettet vi har beskrive bruker vi eigenskapen `dcat:servesDataset`. Merk at denne peiker _frå_ Datatjenesten _til_ Datasettet:
...
Vi vil igjen seie her at datasettet er tilgjengelig med Apache-2.0-lisens. I tillegg tilbyr det fiktive API-et vårt dataen i XML- og JSON-format.
