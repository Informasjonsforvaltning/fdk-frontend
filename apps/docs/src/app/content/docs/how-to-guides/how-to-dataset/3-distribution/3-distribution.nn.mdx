...
<Alert
    size='sm'
>
    **Merk**: Vi skiller mellom Datasett, Distribusjon og Datatjeneste/API for å tydeleggjere at eit datasett kan tilgjengeleggjast på fleire måtar.
    I denne samanhengen er datasett ein ganske abstrakt ting, medan dei konkrete filene og endepunkta du kan hente dataen frå kallast for distribusjon og datatjeneste.
</Alert>
...
Distribusjonen har ein Apache 2.0-lisens, som vi angir med eigenskapen `dct:license`. Denne eigenskapen _skal_ peike til eit kontrollert vokabular/kodeliste frå EU.
