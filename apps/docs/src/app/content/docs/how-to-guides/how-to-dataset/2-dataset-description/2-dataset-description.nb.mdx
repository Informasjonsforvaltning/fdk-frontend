...
>
    **Nyttig å vite**: Vi må lage beskrivelsen i et strukturert dataformat som data.norge.no sitt system kan forstå.
    ...
    RDF-formatet som heter Turtle – men du velger selv hvilket du vil bruke. Du kan [lese mer om RDF her](/rdf)
</Alert>
...
I tillegg har vi skrevet en egen [side om hvordan bruke koder](/docs/tutorials/code-lists) for å merke datasett tematisk. Ta gjerne en kikk der om du lurer på noe.
