...
<Alert
    ...
    size='sm'
>
    **Merk**: Datasettet _KI-prosjekter i offentlig sektor_ er ikke tilgjengeliggjort via API, så lenkene og endepunktene oppgitt for API-et i eksempelet under er ikke virkelige og vil ikke fungere.
    Eksemplene her er kun ment å illustrere hvordan en API-beskrivelse ser ut.
</Alert>
