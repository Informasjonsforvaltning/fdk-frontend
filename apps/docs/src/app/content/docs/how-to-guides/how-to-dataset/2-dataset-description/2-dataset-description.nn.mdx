...
<Alert
    ...
    size='sm'
>
    **Nyttig å vite**: Vi må lage beskrivinga i eit strukturert dataformat som data.norge.no sitt system kan forstå. Dette formatet heiter RDF (Resource Description Framework) og er i bruk òg blant andre europeiske dataportalar og i fleire private verksemder sine datakatalogar.
    RDF kan skrivast på fleire ulike måtar – i døma under bruker vi RDF-formatet som heiter Turtle – men du vel sjølv kva for eitt du vil bruke. Du kan [lese meir om RDF her](/rdf)
</Alert>
...
Alle datasettbeskrivingar må ha minst eitt tema angitt med dcat:theme, og temaet må anten peike til kodelista Data Theme eller kodelista EuroVoc. I tillegg kan du peike til tema frå kodelista LOS som Digdir forvaltar.
...
I tillegg har vi skrive ei eiga [side om korleis bruke kodar](/docs/tutorials/code-lists) for å merke datasett tematisk. Ta gjerne ein kikk der om du lurer på noko.
...
<Alert
    ...
    size='sm'
>
    **Tips**: For å finne ut kvar det eventuelt er syntaksfeil kan du sjekke beskrivinga di på [https://www.easyrdf.org/converter](https://www.easyrdf.org/converter).
    Den gir tilbakemelding om kva linje som inneheld feil, men den veit ingenting om beskrivinga di er i samsvar med DCAT-AP-NO. 
</Alert>
