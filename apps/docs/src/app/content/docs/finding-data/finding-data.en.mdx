...
<Ingress size='xs'>
    Data.norge.no provides a comprehensive overview of datasets, terms, APIs, information models, services, and
    events in the public sector, including data with legal restrictions such as confidentiality or personal information.
    The purpose of this overview is to make it easier for you to find, understand, and use data from the public
    sector. To help navigate all the descriptions, Data.norge.no offers different ways to search. If you can't
    find the data you're looking for, you can register a request.
</Ingress>
...
<Alert
    size="sm"
>
You can read more about finding and assessing data on [the Digitalisation Agency's pages.](https://www.digdir.no/datadeling/finne-og-vurdere-data/2256#hvor_kan_du_finne_dataene)
</Alert>
