På denne siden lærer du hvordan lage beskrivelser du forvalter selv, slik at de kan publiseres til Data.norge.no. Du må da sette opp høsting i høsteløsningen til Data.norge.no for å publisere beskrivelsene.


> **__Info:__**
På denne siden lærer du hvordan lage beskrivelser du forvalter selv, slik at de kan publiseres til Data.norge.no. Du må da [sette opp høsting](/getting-started/publishing-descriptions) i høsteløsningen til Data.norge.no for å publisere beskrivelsene.
...
Se [Om spesifikasjonene](/getting-started/resources) for mer informasjon om de ulike spesifikasjonene Data.norge.no baserer seg på.
...
[Flere relevante ressurser](/getting-started/resources)
...
Når du har laget en beskrivelse kan du [sette opp høsting](/getting-started/publishing-descriptions) slik at den publiseres til Data.norge.no.
