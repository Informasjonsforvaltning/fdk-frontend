...
<Ingress>
    ...
    neste steg må du [sette opp høsting](/docs/tutorials/publishing-data-descriptions/3-publishing-descriptions) i
    høsteløsningen til Data.norge.no for å publisere beskrivelsene.
</Ingress>

## Hvordan lage RDF-grafer

Vi anbefaler at du bruker veiledningen vår som gjennom eksempler viser [hvordan du lager en datasettbeskrivelse fra A-Å](/docs/how-to-guides/how-to-dataset).

Du kan i tillegg bruke disse ressursene for å lære mer om RDF og hvordan lage datasettbeskrivelser:

-   [Kræsjkurs i RDF og Turtle](/docs/tutorials/rdf-crash-course)
...
<Alert size='sm'>
    Se [Flere relevante ressurser](/docs/additional-resources) for mer informasjon om de ulike spesifikasjonene
...
Når du har laget en beskrivelse kan du [sette opp høsting](/docs/tutorials/publishing-data-descriptions/3-publishing-descriptions) slik at den publiseres til Data.norge.no.
