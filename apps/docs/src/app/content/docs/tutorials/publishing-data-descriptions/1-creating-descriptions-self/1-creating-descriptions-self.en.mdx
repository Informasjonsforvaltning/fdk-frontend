On this page, you will learn how to create descriptions you manage yourself, so they can be published to Data.norge.no. You will need to set up harvesting in Data.norge.no's harvesting solution to publish the descriptions.

> **__Info:__**
On this page, you will learn how to create descriptions you manage yourself, so they can be published to Data.norge.no. You will need to [set up harvesting](/getting-started/publishing-descriptions) in Data.norge.no's harvesting solution to publish the descriptions.

## How to create RDF graphs

Use these guides to learn more about how to create dataset descriptions:
...
- [Workshop materials on RDF and dataset descriptions](https://github.com/fellesdatakatalog/sikt-workshop/blob/main/ressurshefte/ressurshefte.md)

The descriptions you create must be in an RDF format and conform to the specification for the resource being described.

See [About the specifications](/getting-started/resources) for more information on the various specifications Data.norge.no is based on.
...
[More relevant resources](/getting-started/resources)
...
Once you have created a description, you can [set up harvesting](/getting-started/publishing-descriptions) so that it is published to Data.norge.no.
