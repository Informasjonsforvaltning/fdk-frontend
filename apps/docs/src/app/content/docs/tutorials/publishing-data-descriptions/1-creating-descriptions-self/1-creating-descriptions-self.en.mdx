...
<Ingress>
    ...
    Data.norge.no. In the next step you will need to [set up
    harvesting](/docs/tutorials/publishing-data-descriptions/3-publishing-descriptions) in Data.norge.no's harvesting
    solution to publish the descriptions.
</Ingress>
