...
<Ingress>
    ...
    Data.norge.no. In the next step you will need to [set up harvesting](/docs/tutorials/publishing-data-descriptions/3-publishing-descriptions) in
    Data.norge.no's harvesting solution to publish the descriptions.
</Ingress>

## How to create RDF graphs

We recommend using our guide, which shows through examples [how to create a dataset description from A to Z](/docs/how-to-guides/how-to-dataset).
...
<Alert
    ...
    size='sm'
>
    See [Additional relevant resources](/docs/additional-resources) for more information on the various specifications
...
Once you have created a description, you can [set up harvesting](/docs/tutorials/publishing-data-descriptions/3-publishing-descriptions) so that it is published to Data.norge.no.
