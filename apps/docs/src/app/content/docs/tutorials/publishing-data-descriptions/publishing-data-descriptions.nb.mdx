...
<Alert
    ...
    size="sm"
>
    Lenger frem i veiledningen får du informasjon om [Hvordan registrere endepunkt for høsting](/docs/tutorials/publishing-data-descriptions/3-publishing-descriptions)
</Alert>
