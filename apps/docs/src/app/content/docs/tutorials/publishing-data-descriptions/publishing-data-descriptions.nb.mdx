...
[Neste steg](/docs/tutorials/publishing-data-descriptions/1-creating-descriptions-self) i veiledningen viser hvordan du lager beskrivelser.

<Alert size='sm'>
    Lenger frem i veiledningen får du informasjon om [Hvordan registrere endepunkt for
    høsting](/docs/tutorials/publishing-data-descriptions/3-publishing-descriptions)
</Alert>
...
-   [Hvordan lage beskrivelser med registreringsløsningen](/docs/tutorials/publishing-data-descriptions/2-creating-descriptions-registration)
...
-   [Hvordan lage beskrivelser selv](/docs/tutorials/publishing-data-descriptions/1-creating-descriptions-self), eller
-   [Hvordan lage beskrivelser med registreringsløsningen](/docs/tutorials/publishing-data-descriptions/2-creating-descriptions-registration)
