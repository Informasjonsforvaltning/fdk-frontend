...
The European data portal [data.europa.eu](data.europa.eu) is based on RDF and retrieves descriptions from, among others, data.norge.no. This means that data.norge.no must offer it in RDF.

All descriptions of data catalogs for both data.norge.no and [data.europa.eu](https://data.europa.eu) follow a standard called [DCAT (Data Catalog Vocabulary)](https://www.w3.org/TR/vocab-dcat-3/) which is defined in RDF.

## More Information about RDF

If you want to learn more about how RDF works, you can take a look at our [crash course](/nb/docs/tutorials/rdf-crash-course).
