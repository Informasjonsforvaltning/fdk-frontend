import { Ingress, Alert, Paragraph, Card, Heading } from '@digdir/designsystemet-react';

# Hjelp til å finne data

<Ingress size="xs">Vet du ikke om data du ser etter finnes eller er det data du trenger som ikke er delt ennå? Hvis datasettet ikke er beskrevet på Data.norge.no eller på dataeiers nettsider, bør du gå i dialog med de som tilbyr dem og oppfordre dem til å dele. Du kan bruke Digdirs tjenester til dette, ved å spørre Datajegeren eller etterspørre datasett og API-er i Datalandsbyen.</Ingress>
...
<Alert severity="info" size="md">
	Hei dette er en infoboks fra Designsystemet
</Alert>