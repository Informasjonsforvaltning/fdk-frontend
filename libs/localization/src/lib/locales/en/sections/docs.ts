const docs = {
  titles: {
    "/om-transportportal": "About Transportportal.no",
    "/om-transportportal/roller-og-ansvar": "Roles and responsibilities",
    "/om-transportportal/its-direktiv-og-forordninger": "The ITS Directive and regulations",
    ...
    "/docs/sharing-data/about-registration": "Get started with registration",
    "/docs/sharing-data/about-harvesting": "Get started with harvesting",
    ...
    "/docs/sharing-data/terms-of-use": "Terms of use",
