const dataHunterPage = {
  ...
  aboutDatasetCatalog: "About dataset catalog",
  aboutInformationModelCatalog: "About Information model catalog",
  aboutNationalDataCatalog: "About Felles datakatalog",
  aboutWebsite: "About the website",
  ...
  error: {
    ...
    formSubmit: "An error occurred while submitting the form. Please try again later.",
  ...
  guidance: "Guidance",
  guidanceAndStandards: "Guidance and standards",
  homePage: "Home",
  language: "Language",
  menuButton: "Menu",
  name: "Name",
  ...
  norwegianBokmaal: "Norwegian bokmål",
  ...
  services: "Services",
  shouldBeFilledOut: "Must be filled out",
