const detailsPage = {
  ...
  accessRights: {
    ...
    codes: {
      NON_PUBLIC: {
        ...
        helpText:
          "Not publicly available due to privacy, security, or other reasons. This category may include resources containing sensitive or personal information.",
      },
      RESTRICTED: {
        label: "Restricted access",
        helpText:
          "Only available under certain conditions. This category may include resources requiring payment, resources shared under confidentiality agreements, or resources where the publisher or owner has not yet decided if they can be made public.",
      },
      PUBLIC: {
        label: "Public access",
        helpText:
  ...
  overview: {
    description: {
      ...
      informationModelPlaceholder: "This information model has no description",
    },
    servesDataset: {
  ...
  details: {
    ...
    general: {
      ...
      firstHarvestedInformationModelHelpText:
        "This date indicates when the information model was harvested by data.norge.no. It may have been available earlier elsewhere.",
  ...
  datasetPreview: {
    ...
    previewNotAvailableHelpText:
      "Preview is only available for data sources with CSV, XLS/XLSX, JSON, and XML formats.",
