const docs = {
  titles: {
    ...
    "/docs/sharing-data/about-registration": "Kom i gang med registrering",
    "/docs/sharing-data/about-harvesting": "Kom i gang med hausting",
    ...
    "/docs/sharing-data/terms-of-use": "Bruksvilkår",
