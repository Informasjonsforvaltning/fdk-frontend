const detailsPage = {
  ...
  header: {
    ...
    namelessInformationModel: "Namnlaus informasjonsmodell",
    ...
    informationModelsTagLink: "Informasjonsmodellar",
    published: "Publisert",
  ...
  accessRights: {
    ...
    codes: {
      NON_PUBLIC: {
        ...
        helpText:
          "Ikkje offentleg tilgjengeleg grunna personvern, tryggleik eller andre årsaker. Denne kategorien kan omfatte ressursar som inneheld sensitiv eller personleg informasjon.",
      },
      RESTRICTED: {
        label: "Avgrensa tilgang",
        helpText:
          "Berre tilgjengeleg under visse vilkår. Kan inkludere ressursar som krev betaling, ressursar delt under teiepliktsavtalar, eller ressursar der utgjevar eller eigar ikkje har avgjort om dei kan offentleggjerast.",
      },
      PUBLIC: {
  ...
  overview: {
    description: {
      ...
      informationModelPlaceholder: "Denne informasjonsmodellen har inga skildring",
    },
    servesDataset: {
  ...
  details: {
    ...
    general: {
      ...
      firstHarvestedInformationModelHelpText:
        "Denne datoen viser når informasjonsmodellen vart henta inn av data.norge.no. Den kan ha vore tilgjengeleg tidlegare andre stader.",
