const sparqlSandboxPage = {
  metadata: {
    ...
    description:
      "Utforsk og spør etter norske offentlege data ved hjelp av SPARQL. Utfør egendefinerte spørjingar på datasett, omgrep, API-ar og informasjonsmodellar frå over 125 organisasjonar. Test dine SPARQL-spørjingar i vårt interaktive sandbox-miljø.",
  },
