const detailsPage = {
  ...
  header: {
    ...
    namelessInformationModel: "Navnløs informasjonsmodell",
    ...
    informationModelsTagLink: "Informasjonsmodeller",
    published: "Publisert",
  ...
  accessRights: {
    ...
    codes: {
      NON_PUBLIC: {
        ...
        helpText:
          "Ikke offentlig tilgjengelig av personvern-, sikkerhets- eller andre årsaker. Denne kategorien kan inkludere ressurser som inneholder sensitiv eller personlig informasjon.",
      },
      RESTRICTED: {
        label: "Begrenset tilgang",
        helpText:
          "Kun tilgjengelig under visse betingelser. Denne kategorien kan inkludere ressurser som krever betaling, ressurser delt under taushetsavtaler, eller ressurser der utgiver eller eier ennå ikke har bestemt om de kan offentliggjøres.",
      },
      PUBLIC: {
  ...
  overview: {
    description: {
      ...
      informationModelPlaceholder: "Denne informasjonsmodellen har ingen beskrivelse",
    },
    servesDataset: {
  ...
  details: {
    ...
    general: {
      ...
      firstHarvestedInformationModelHelpText:
        "Denne datoen sier når informasjonsmodellen ble høstet av data.norge.no. Den kan ha vært tilgjengelig tidligere andre steder.",
    ...
    content: {
      ...
      dataServiceConformsToHelpText:
        "Referanse til en etablert teknisk standard eller spesifikasjon som API-et er i samsvar med.",
    },
    legal: {
      title: "Lovhjemler",
    ...
    requiredEvidence: {
      ...
      identifier: "Identifikator",
      language: "Språk",
      page: "Om dokumentasjonen",
      dctType: "Type dokumentasjon",
    },
    references: {
      title: "Referanser",
  ...
  datasetPreview: {
    ...
    previewNotAvailableHelpText:
      "Forhåndsvisning er kun tilgjengelig for datakilder med CSV, XLS/XLSX, JSON og XML format.",
  ...
  unknownStatusLabel: "Ukjent status",
  statusCodes: {
