const docs = {
  titles: {
    ...
    "/docs/catalogs": "Datakataloger",
    "/docs/catalogs/datasets": "Datasett",
    "/docs/catalogs/data-services": "API-er",
    "/docs/catalogs/information-models": "Informasjonsmodeller",
    "/docs/catalogs/concepts": "Begreper",
    "/docs/catalogs/public-services-and-events": "Tjenester og hendelser",
