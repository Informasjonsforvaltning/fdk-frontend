...
export const EnvironmentVariablesProvider = ({
    children,
    vars,
}: EnvironmentVariablesProviderProps & PropsWithChildren) => {
    return <EnvironmentVariablesContext.Provider value={vars}>{children}</EnvironmentVariablesContext.Provider>;
};
