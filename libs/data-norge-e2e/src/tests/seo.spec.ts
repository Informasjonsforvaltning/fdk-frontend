...
test.describe("SEO Tests", () => {
  ...
  test.describe.skip("sitemap.xml", () => {
    ...
    test("should have deep content subpages in sitemap", async ({ page }) => {
      ...
      const deepSubpages = [
        ...
        "docs/sharing-data/about-registration",
        "docs/sharing-data/about-harvesting",
        "docs/sharing-data/terms-of-use",
  ...
  test.describe("JSON-LD Structured Data", () => {
    test("should contain valid JSON-LD structured data on dataset pages", async ({ page }) => {
      ...
      await expect(page.locator('script[id="dataset-structured-data"][type="application/ld+json"]')).toHaveCount(1);
