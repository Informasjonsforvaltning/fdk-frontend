...
const mediaFormats = [
    ...
    {
        label: "vnd.openxmlformats-officedocument.spreadsheetml.sheet (54)",
                            ...
                            <Dropdown.TriggerContext>
                                ...
                                >
                                    <VStack>
                                        ...
                                        <Box className={styles.box}>
                                            <CheckboxGroup options={[...temaOptions, ...euTemaOptions]} />
                                        </Box>
                                    </VStack>
                                </Dropdown>
                            </Dropdown.TriggerContext>
                                    ...
                                    >
                                        ...
                                        >
                                            <VStack>
                                                ...
                                                <Box className={styles.box}>
                                                    <CheckboxGroup options={mediaFormats} />
                                                </Box>
                                            </VStack>
                                        </Tabs.Panel>
                                        <Tabs.Panel
                                        ...
                                        >
                                            <VStack>
                                                ...
                                                <Box className={styles.box}>
                                                    <CheckboxGroup options={filetype} />
                                                </Box>
                                            </VStack>
                                        </Tabs.Panel>
                                    </Tabs>
                            ...
                            <Dropdown.TriggerContext>
                                ...
                                >
                                    <VStack>
                                        ...
                                        <Box className={styles.box}>
                                            <CheckboxGroup options={geography} />
                                        </Box>
                                    </VStack>
                                </Dropdown>
                            </Dropdown.TriggerContext>
