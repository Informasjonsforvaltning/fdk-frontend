    ...
    return (
        ...
        >
            <Paragraph data-size="md">
                <strong>KI-søket</strong> bruker metadata fra data.norge.no og hjelper deg med å finne det du leter
                etter i alle våre datakataloger. Ved å bruke naturlig språk kan du søke fritt uten å måtte kjenne til
                spesifikke datasettnavn, fagtermer eller tekniske formater.
            </Paragraph>
