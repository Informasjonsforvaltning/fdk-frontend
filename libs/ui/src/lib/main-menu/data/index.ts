...
const getMainMenuData = (dictionary: Localization, locale: string) => ({
    catalogs: [
        ...
        },
        {
            ...
            href: `/${locale}/search/information-models`,
        },
        {
            key: 'services-events',
            ...
            href: `/${locale}/search/services-and-events`,
        },
    ],
    help: [
        {
